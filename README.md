...
npx dumpall ./ -o context.md -e ".vscode" -e "dist" -e "logs" -e "node_modules" -e ".env.example" -e ".env.test" -e ".gitignore" -e ".prettierrc" -e "context.md" -e "eslint.config.msj" -e "package-lock.json" -e "README.md" -e "TODO.MD"
