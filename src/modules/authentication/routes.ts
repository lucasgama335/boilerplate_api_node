...
authRoutes.post('/login', authRateLimiter, validateDataMiddleware(authenticateUserSchema), authenticateController.loginUser);
authRoutes.post('/refresh', authRateLimiter, authenticateController.refreshToken);
