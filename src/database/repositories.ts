import { DrizzleLoginAttemptsRepository } from '@/modules/authentication/repositories/login-attempts.repository';
...
export const loginAttemptRepository = new DrizzleLoginAttemptsRepository(databaseInstance);
