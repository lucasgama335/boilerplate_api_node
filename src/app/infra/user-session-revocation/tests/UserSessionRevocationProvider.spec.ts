...
import { UserSessionRevocationProvider } from '../UserSessionRevocationProvider';

describe('UserSessionRevocationProvider', () => {
    let usersRepository: InMemoryUserRepository;
    let cache: InMemoryRedisCache;
    let provider: UserSessionRevocationProvider;

    beforeEach(() => {
        usersRepository = new InMemoryUserRepository();
        cache = new InMemoryRedisCache();
        provider = new UserSessionRevocationProvider(usersRepository, cache);
    });
